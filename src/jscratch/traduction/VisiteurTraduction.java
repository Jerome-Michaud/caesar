...
public abstract class VisiteurTraduction implements VisiteurElementProg {
	 ...
	 *
	 * @param indentationTabulation si <code>false</code> l'indentation sera effectuée avec des espaces, sinon des tabulations
	 */
	public void setIdentationTabulation(final boolean indentationTabulation) {
		this.identationTabulation = indentationTabulation;
	}
}