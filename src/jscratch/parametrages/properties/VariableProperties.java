...
public final class VariableProperties {
	...
	public static final String CHEMIN_ACCES_NBC_LINUX = PropertiesHelper.getInstance().get("user.chemin.compilateur.linux").replace("\\", File.separator).replace("/", File.separator);
