...
/**
 * Classe héritant d'Exception permettant de définir une erreur à lever quand un
 * composant n'est pas trouvé dans l'arborescence.
...
public class ComposantIntrouvableException extends Exception {
    ...
    /**
     * Constructeur prenant en paramètre une chaine de caractères faisant appel
     * au contructeur correspondant de la class Exception.
     *
