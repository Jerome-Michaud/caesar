...
/**
 * Classe regroupant différents outils destinés au calcul
 * de la nécessité de fusionner ou non un widget avec un autre.
 *
 * @author Bastien ANDRU - Quentin GOSSELIN
 */
public class FusionTools {
	/**
	 * Constante stockant la marge à appliquer lors du calcul du survol d'un widget
	 */
    public static final int MARGE_AIMENT = 10;
    /**
     * Méthode statique permettant de définir si on survol ou non un widget.
     * Si oui, définit si on le survole par le dessous, le dessus ou, dans le cas
     * d'un widget complexe, si on survole l'une de ses zones d'accroche.
     *
     * @param comp Le widget en cours de draggage pour lequel on doit vérifier si il survole ou non un autre widget
     * @return Une objet de type Action regroupant les informations nécessaires au traitement du survol.
     */
