...
public class ArborescenceTools {
	...
	/**
	 * Methode permettant de récupérer la position du widget passé en paramètre
	 ...
	 * associé au premier élèment de la liste passée en paramètre
	 *
	 ...
	 * lancement du programme, ou à une autre arborescence complètement nouvelle au
	 * moment du chargement d'un projet sauvegardé.
	 *
	 * @param l La liste de liste de widgets symbolisant la nouvelle
	 * aroborescence à attribuer au programme
	 ...
	 * programme chaque widget. Cette méthode est appelée récursivement lorsque
	 * le widget qui doit être ajouté à l'arborescence est complexe, afin
	 * d'ajouter à l'arborescence ses widgets fils.
	 *
	 * @param liste la liste des widgets à ajouter dans l'arborescence
	 * @param initListener Valeur booléenne indiquant si on veut initialiser
	 * les listeners de chaque widget (cas du chargement d'une projet
	 * sauvegardé) ou non (cas du lancement du programme)
	 */
