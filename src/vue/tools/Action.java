...
/**
 * Classe utilisée au moment du survol et de la fusion d'un widget et permettant d'encapsuler au sein d'un même objet un widget et le type de survol
...
public class Action {
	 ...
	 * @param val La valeur du survol :
	 * <ul>
	 * <li>0 : survol par le dessous</li>
	 * <li>1 : survol d'un widget par le dessus</li>
	 * <li>2: survol d'une zone d'accroche</li>
	...
	/**
	 * Récupération du rectangle symbolisant la zone d'accroche en cours de survol.
	 *
	 * @return Le rectangle symbolisant la zone d'accroche survolée.<br/>
	 * null si on ne survole pas un zone d'accroche.
	 */
	...
	/**
	 * Récupération du point sur lequel sera basée la translation de la ligne en cas de survol d'un zone d'accroche.
	 *
	 * @return Le point de translation.<br/>
	 * null si on ne survole pas de zone d'accroche.
	 */
	...
	/**
	 * Définition du point permettant de calculer la translation à appliquer à la ligne en cas de survol d'une zone d'accroche.
	 *
	 ...
	 *
	 * @return La valeur associée au survol :
	 * <ul>
	 * <li>0 : survol par le dessous</li>
	 * <li>1 : survol d'un widget par le dessus</li>
	 * <li>2 : survol d'une zone d'accroche</li>
