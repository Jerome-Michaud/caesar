 ...
 * d'encapsuler au sein d'un même objet un widget et le type de survol (au
 * dessus, en dessous ou bien survol d'un zone d'accroche).
 *
 * Cette objet peut également contenir d'autres objets utiles à certains
...
public class Action {
    ...
    /**
     * Permet de définir l'indice de la liste de zones ou trouver le composant ou sera fusionné le widget variable
