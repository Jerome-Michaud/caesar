 ...
 * forme d'un widget de type ExpressionOperatorSup.
 * 
 * @author CHOUKET Houda
 */
public class ExpressionOperatorSupWidget extends ModeleWidget {
	/**
	 * Constructeur du modele definissant les differents parametres du ExpressionOperatorSup .
	 */

	public ExpressionOperatorSupWidget() {
		super();
