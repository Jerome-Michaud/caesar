 ...
 * forme d'un widget de type ExpressionOR.
 * 
 * @author CHOUKET Houda
 */
public class ExpressionOrWidget extends ModeleWidget {
	/**
	 * Constructeur du modele definissant les differents parametres du ExpressionOR .
	 */
	public ExpressionOrWidget() {
		super();
