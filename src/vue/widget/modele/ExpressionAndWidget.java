 ...
 * forme d'un widget de type ExpressionAND.
 * 
 * @author CHOUKET Houda
 */
public class ExpressionAndWidget extends ModeleWidget {
	/**
	 * Constructeur du modele definissant les differents parametres du ExpressionAND .
	 */
	public ExpressionAndWidget() {
		super();
